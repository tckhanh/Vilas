<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/QuanLyMau.Master" AutoEventWireup="true" CodeBehind="1-TraKetQua.aspx.cs" Inherits="LabManagement.TraKetQua" UICulture="vi-vn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 780px">
        ...
        <tr>
            <td class="style62" align="center">&nbsp;</td>
            <td class="style63" align="center">
                <dx:ASPxButton ID="btConfirmEUT" runat="server"
                    CssFilePath="~/App_Themes/SoftOrange/{0}/styles.css" CssPostfix="SoftOrange"
                    SpriteCssFilePath="~/App_Themes/SoftOrange/{0}/sprite.css"
                    Text="Xác nhận trả mẫu đo" Width="160px" OnClick="btConfirmEUT_Click">
                </dx:ASPxButton>
            </td>
            <td class="style60" align="center">
                <dx:ASPxButton ID="btConfirmTestRP" runat="server"
                    CssFilePath="~/App_Themes/SoftOrange/{0}/styles.css" CssPostfix="SoftOrange"
                    SpriteCssFilePath="~/App_Themes/SoftOrange/{0}/sprite.css"
                    Text="Xác nhận trả KQ" Width="160px" OnClick="btConfirmTestRP_Click">
                </dx:ASPxButton>
            </td>
            <td class="style61" align="center">
                <dx:ASPxButton ID="btConfirmRedBill" runat="server"
                    CssFilePath="~/App_Themes/SoftOrange/{0}/styles.css" CssPostfix="SoftOrange"
                    SpriteCssFilePath="~/App_Themes/SoftOrange/{0}/sprite.css"
                    Text="Xác nhận trả hóa đơn" Width="160px" OnClick="btConfirmRedBill_Click">
                </dx:ASPxButton>
            </td>
        </tr>
    </table>
        ...
        <tr>
            ...
            <td>
                <dx:ASPxButton ID="btPrintBill" runat="server"
                    ...
                    <ClientSideEvents Click="function (s, e) {window.open('ReportForm/BillPaperFromRelease.aspx', '_blank')}" />
                </dx:ASPxButton>
            </td>
        </tr>
    </table>
        ...
        <dx:ASPxGridView ID="ASPxGridView3" runat="server"
            ...
            <Columns>
                ...
                <dx:GridViewDataDateColumn Caption="Ngày trả dự kiến"
                    FieldName="AppointmentDate" VisibleIndex="15">
                    <PropertiesDateEdit>
                        <CalendarProperties ClearButtonText="Xóa" TodayButtonText="Hôm nay">
                        </CalendarProperties>
                    </PropertiesDateEdit>
                ...
                <dx:GridViewDataComboBoxColumn Caption="Người trả mẫu"
                    FieldName="ReturnStaffID" Visible="False" VisibleIndex="20">
                ...
                <dx:GridViewDataComboBoxColumn Caption="Người trả KQ"
                    FieldName="ReturnRPStaffID" Visible="False" VisibleIndex="22">
                    <PropertiesComboBox DataSourceID="SqlDataSourceStaff" TextField="StaffFullName"
                        ValueField="StaffID" ValueType="System.String">
                    </PropertiesComboBox>
                    <EditFormSettings Visible="True" />
                ...
                <dx:GridViewDataComboBoxColumn Caption="Tình trạng hóa đơn"
                    FieldName="HoldRedBill" Visible="False" VisibleIndex="25">
