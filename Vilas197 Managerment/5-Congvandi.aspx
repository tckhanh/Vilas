<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/QuanLyHTCL.Master" AutoEventWireup="True" CodeBehind="5-Congvandi.aspx.cs" Inherits="LabManagement._5_Congvandi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<dx:ASPxLabel 
            ID="ASPxLabel6" runat="server" Text="QUẢN LÝ CÔNG VĂN ĐI" 
    ...
    <p>
        &nbsp;</p>
            <table class="style19" style="height: 9px; width: 68%">
                <tr>
        ...
        <dx:ASPxLabel ID="ASPxLabel7" runat="server" CssClass="style19" 
            ...
            Text="Thông tin Công văn đi" ForeColor="#CC3300">
        </dx:ASPxLabel>
        </strong>
                    </td>
                    <td>
                ...
                <dx:ASPxHyperLink ID="ASPxHyperLink3" runat="server" 
                    NavigateUrl="~/0-CauhinhHT.aspx" Text="Cập nhật đơn vị nhận CV" Font-Bold="True" 
                            Font-Italic="False" Font-Size="Small" ForeColor="#0000CC" />
                    </td>
                    <td>
                <dx:ASPxHyperLink ID="ASPxHyperLink2" runat="server" 
                    NavigateUrl="~/5-DanhmucCVdi.aspx" Text="Trở về trang trước" Font-Bold="True" 
                            Font-Italic="False" Font-Size="Small" ForeColor="#0000CC" />
                    </td>
                </tr>
            </table>
            ...
            <table style="height: 196px; width: 67%">
                <tr>
    ...
    <strong>
        ...
        <dx:ASPxLabel ID="ASPxLabel8" runat="server" CssClass="style19" 
            Font-Bold="True" Font-Italic="False" Font-Size="Medium" 
            Text="Danh mục Công văn đi" ForeColor="#CC3300">
        </dx:ASPxLabel>
        </strong>
                    </td>
                    <td>
	...
	s.PerformCallback(s.GetFocusedRowIndex());
            ...
            <Columns>
                ...
                <dx:GridViewDataComboBoxColumn Caption="Đơn vị nhận CV" FieldName="OfficeID" 
                ...
                <dx:GridViewDataDateColumn FieldName="OutDate" VisibleIndex="3" 
                    Caption="Ngày CV đi" Width="100px">
                    <EditFormSettings Visible="False" />
                    <CellStyle HorizontalAlign="Center">
                    </CellStyle>
                </dx:GridViewDataDateColumn>
...
<PropertiesHyperLinkEdit Text="File đính kèm">
    <Style Font-Bold="True">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT DocID, DocCatID, SeriNo, DocNo, DocDate, About, OutDate, FileName, URL, CreateStaffID, CreateDate, ModifyStaffID, ModifyDate, Invalid, Deleted, OfficeID FROM QS_DocOuts WHERE (Deleted = @Deleted) AND (Invalid = @DisplayInvalid OR Invalid = @False)" 
            
            
            UpdateCommand="UPDATE QS_DocOuts SET DocNo = @DocNo, DocDate = @DocDate, About = @About, ModifyStaffID = @ModifyStaffID, ModifyDate = @ModifyDate, Invalid = @Invalid, OfficeID = @OfficeID, DocCatID = @DocCatID WHERE (DocID = @DocID)" 
