...
{
    public partial class _5_BanHanh : System.Web.UI.Page
    {
        Boolean myNewButton;
 ...
 */
        ...
        protected void ASPxGridView2_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            QS_DocIssue my = myQS.QS_DocIssues.SingleOrDefault(p => p.IssueID.ToString() == e.Keys[ASPxGridView2.KeyFieldName]);
        ...
        {
            lblIssueID.Text = ASPxGridView2.GetRowValues(Convert.ToInt32(e.Parameters), "IssueID").ToString();

            txtIssueNo.Text = ASPxGridView2.GetRowValues(Convert.ToInt32(e.Parameters), "IssueNo").ToString();
            ASPxDateIssue.Value = ASPxGridView2.GetRowValues(Convert.ToInt32(e.Parameters), "IssueDate").ToString();
            txtDecisionNo.Text = ASPxGridView2.GetRowValues(Convert.ToInt32(e.Parameters), "DecisionNo").ToString();
            DateEditDecisionDate.Value = ASPxGridView2.GetRowValues(Convert.ToInt32(e.Parameters), "DecisionDate").ToString();
            txtUploadFile.Text = ASPxGridView2.GetRowValues(Convert.ToInt32(e.Parameters), "FileName").ToString();
            MemoNotes.Text = ASPxGridView2.GetRowValues(Convert.ToInt32(e.Parameters), "NotesOfUpdating").ToString();
            txtURL.Text = ASPxGridView2.GetRowValues(Convert.ToInt32(e.Parameters), "URL").ToString();

            if (Convert.ToBoolean(ASPxGridView2.GetRowValues(Convert.ToInt32(e.Parameters), "Invalid")) == true)
        ...
        {
            if (Convert.ToBoolean(ASPxGridView2.GetRowValuesByKeyValue(e.EditingKeyValue, "Invalid")) == true)
            {
                (ASPxGridView2.Columns["Invalid"] as GridViewDataColumn).EditFormSettings.Visible = DefaultBoolean.False;
            }
            else
            {
                (ASPxGridView2.Columns["Invalid"] as GridViewDataColumn).EditFormSettings.Visible = DefaultBoolean.True;
            }
        }
    } 
}