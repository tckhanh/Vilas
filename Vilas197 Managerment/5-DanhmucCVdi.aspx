<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/QuanLyHTCL.Master" AutoEventWireup="true" CodeBehind="5-DanhmucCVdi.aspx.cs" Inherits="LabManagement.DanhmucCVdi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<dx:ASPxLabel 
            ID="ASPxLabel6" runat="server" Text="DANH MỤC CÔNG VĂN ĐI" 
    ...
    <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" Font-Bold="True" 
        Font-Italic="False" ForeColor="Blue" NavigateUrl="~/5-Congvandi.aspx" 
        Text="Cập nhật Công văn đi" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
    <dx:ASPxHyperLink ID="ASPxHyperLink2" runat="server" Font-Bold="True" 
        Font-Italic="False" ForeColor="Blue" NavigateUrl="~/5-DanhmucCVdiRPT.aspx" 
        Text="In danh mục Công văn đi" />
    <br />
    <br />
    <dx:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            <dx:GridViewDataTextColumn FieldName="SeriNo" 
                VisibleIndex="1" 
                Caption="Số CV đi" ShowInCustomizationForm="True" Width="70px">
            ...
            <dx:GridViewDataTextColumn Caption="Số công văn" FieldName="DocNo" 
                ...
                <PropertiesTextEdit DisplayFormatString="{0}" NullDisplayText="No File Attach">
                </PropertiesTextEdit>
            ...
            <dx:GridViewDataDateColumn Caption="Ngày CV đi" FieldName="OutDate" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT YEAR(OutDate) AS DocYear, QS_DocOuts.* FROM QS_DocOuts WHERE (Invalid = @Invalid) AND (Deleted = @Deleted)">
        <SelectParameters>
