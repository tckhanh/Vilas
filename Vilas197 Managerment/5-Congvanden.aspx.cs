...
{
    public partial class _5_Congvanden : System.Web.UI.Page
    {
        Boolean myNewButton;
        ...
        protected void btSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (CmbType.Value != null && CmbOffice.Value !=null && txtSeriNo.Text != null && txtDocNo.Text != null && ASPxDateIn.Value != null && ASPxDateIssue.Value != null)
                {
                    ...
                    var check = (from p in myQS.QS_DocIns
                    ...
                    else
                    {
                        ...
                        if (my2 != null)
                        {
                            my.SeriNo = Convert.ToInt32(my2.DocNoIn);
                            my2.DocNoIn = my2.DocNoIn + 1;
                        }
                        else
                            my.SeriNo = Convert.ToInt32(txtSeriNo.Text);


                        my.InDate = Convert.ToDateTime(ASPxDateIn.Value);
                        ...
                        myQS.QS_DocIns.InsertOnSubmit(my);
        ...
        {
            QSDataContext myQS = new QSDataContext();
            QS_DocIn my = myQS.QS_DocIns.SingleOrDefault(p => p.DocID.ToString() == txtDocID.Text);
        ...
        protected void btNew_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (my != null)
                    txtSeriNo.Text = Convert.ToString(Convert.ToInt32(my.DocNoIn.ToString()));
                else
                {

                    QS_Option my3 = new QS_Option();
                    my3.Year = Convert.ToInt32(DateTime.Today.Year);
                    my3.DocNoIn = 1;
                    my3.DocNoOut = 1;

                    myQS.QS_Options.InsertOnSubmit(my3);
                    myQS.SubmitChanges();
 ...
 */
        ...
        protected void ASPxGridView1_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            ASPxDateIn.Value = ASPxGridView1.GetRowValues(Convert.ToInt32(e.Parameters), "InDate");
        ...
        protected Boolean TaiFile()
        {
            ...
            {
                lblnotification.Text = "Error: Loại Công văn hoặc loại cơ quan chưa được chọn";
                return false;
            }
            else
            {
