<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/QuanLyHTCL.Master" AutoEventWireup="true" CodeBehind="5-DanhmucCVdenRPT.aspx.cs" Inherits="LabManagement._5_DanhmucCVdenRPT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server" 
        Report="<%# new LabManagement.Report._5_DanhmucCVden() %>" 
        ReportName="LabManagement.Report._5_DanhmucCVden">
