<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/QuanLyHTCL.Master" AutoEventWireup="true" CodeBehind="3-TaoTTNhanSu.aspx.cs" Inherits="LabManagement._3_TaoTTNhanSu" %>
    ...
    <p>
            ...
            <Columns>
                <dx:GridViewCommandColumn VisibleIndex="1" 
                    Width="100px" ShowDeleteButton="True" ShowEditButton="True" ShowNewButtonInHeader="True">
...
<dx:GridViewDataTextColumn FieldName="StaffID" VisibleIndex="0" ReadOnly="True" Visible="False">
                ...
                <dx:GridViewDataTextColumn FieldName="StaffFistName" VisibleIndex="5" 
                    Caption="Tên" Visible="False" >
                    <EditFormSettings Visible="True" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="StaffLastName"
                    VisibleIndex="4" Caption="Họ" Visible="False">
                    <EditFormSettings Visible="True" />
                </dx:GridViewDataTextColumn>
...
<dx:GridViewDataTextColumn FieldName="Department" ShowInCustomizationForm="True" 
    ...
    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                ...
                <dx:GridViewDataTextColumn FieldName="Username" VisibleIndex="18" 
                    Caption="Tên đăng nhập" Visible="False">
                    <EditFormSettings Visible="True" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Password" VisibleIndex="19" 
                    Caption="Mật khẩu" Visible="False">
                    <EditFormSettings Visible="True" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataComboBoxColumn Caption="Tình trạng công việc" 
                    FieldName="InWorking" VisibleIndex="21">
                ...
                <dx:GridViewDataComboBoxColumn Caption="Trạng thái tài khoản" 
                    FieldName="Enable" VisibleIndex="20">
                    <PropertiesComboBox ValueType="System.String">
                        <Items>
                            <dx:ListEditItem Text="Đang bị khóa" Value="0" />
...
<Summary Text="Trang {0}/{1} ({2} Hồ sơ)"></Summary>
             ...
             <SettingsText ConfirmDelete="Bạn có muốn xóa thông tin về nhân sự này không" />
