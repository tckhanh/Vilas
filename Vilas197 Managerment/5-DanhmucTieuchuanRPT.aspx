<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/QuanLyHTCL.Master" AutoEventWireup="true" CodeBehind="5-DanhmucTieuchuanRPT.aspx.cs" Inherits="LabManagement._5_DanhmucTieuchuanRPT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ReportViewer ID="ReportViewer1" runat="server" 
        Report="<%# new LabManagement.Report._5_DanhmucTieuchuan() %>" 
        ReportName="LabManagement.Report._5_DanhmucTieuchuan">
