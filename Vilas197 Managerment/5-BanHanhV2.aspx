<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/QuanLyHTCL.Master" AutoEventWireup="True" CodeBehind="5-BanHanhV2.aspx.cs" Inherits="LabManagement._5_BanHanhV2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        <strong>&nbsp;&nbsp;&nbsp;<dx:ASPxLabel 
            ID="ASPxLabel6" runat="server" Text="QUẢN LÝ BAN HÀNH TÀI LIỆU HỆ THỐNG CHẤT LƯỢNG" 
        ...
        &nbsp;</strong></p>
            <strong>
            <br />
            <table class="style19" style="width: 99%">
                <tr>
                    <td class="style101">
                        &nbsp;</td>
                    <td>
                        &nbsp;<strong><dx:ASPxHyperLink ID="ASPxHyperLink3" runat="server" Font-Bold="True" 
                            ForeColor="#0000CC" NavigateUrl="~/5-TaiLieu.aspx" 
                            Text="Cập nhật danh mục tài liệu" Font-Size="Small" />
        </strong>

            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <dx:ASPxHyperLink ID="ASPxHyperLink2" runat="server" Font-Bold="True" 
                            ForeColor="#0000CC" NavigateUrl="~/5-Danhmucgoc.aspx" 
                            Text="Trở về trang trước" Font-Size="Small" />
                    </td>
                </tr>
                <tr>
    ...
    <strong>
                        <dx:ASPxDateEdit ID="DateEditDecisionDate" runat="server" Height="16px" 
                            Width="188px" EditFormatString="dd/MM/yyyy">
                        </dx:ASPxDateEdit>
        </strong>
                    </td>
                    <td class="style93">
    ...
    <strong>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" Font-Bold="True" 
                                Font-Italic="False" ForeColor="Blue" NavigateUrl="~/5-TaiLieu.aspx" 
                            Text="Cập nhật Danh mục tài liệu" Font-Size="Small" 
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" 
            ...
            <SettingsPager Summary-Text="" Visible="False">
		...
		s.PerformCallback(s.GetFocusedRowIndex());
            ...
            <dx:GridViewDataTextColumn FieldName="DocID" VisibleIndex="3" 
                ...
                <dx:GridViewDataComboBoxColumn FieldName="DocTypeID" VisibleIndex="1" 
                ...
                <dx:GridViewDataTextColumn FieldName="Title" VisibleIndex="5" 
                    ShowInCustomizationForm="True" Width="300px" Caption="Tên tài liệu">
                    <Settings AutoFilterCondition="Contains" />
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="ModifyStaffID" 
                    ShowInCustomizationForm="True" VisibleIndex="7" Caption="Người cập nhật" 
                    Width="100px">
                ...
                <dx:GridViewDataCheckColumn Caption="Hết hiệu lực" FieldName="Invalid" 
            ...
            <Settings EnableFilterControlPopupMenuScrolling="True" 
            ...
            <Templates>
                <DetailRow>
                    ...
                    <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" 
                        ...
                        CssPostfix="Office2003Blue" DataSourceID="SqlDataSource2" 
                        EnableCallBacks="False" KeyFieldName="IssueID" 
                        ...
                        onstartrowediting="ASPxGridView2_StartRowEditing1" Width="702px">
                        <ClientSideEvents RowDblClick="function(s, e) {
	s.PerformCallback(s.GetFocusedRowIndex());
}" />
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="IssueID" ReadOnly="True" Visible="False" 
                                VisibleIndex="1">
                            ...
                            <dx:GridViewDataTextColumn Caption="Số Quyết định" FieldName="DecisionNo" 
                                VisibleIndex="5" Width="100px">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataDateColumn Caption="Ngày Quyết định" FieldName="DecisionDate" 
                            ...
                            <dx:GridViewDataHyperLinkColumn Caption="Đường liên kết" FieldName="URL" 
                                Visible="False" VisibleIndex="8">
                                <PropertiesHyperLinkEdit TextField="FileName">
                                </PropertiesHyperLinkEdit>
                            </dx:GridViewDataHyperLinkColumn>
                            <dx:GridViewDataDateColumn FieldName="ExpireDate" Visible="False" 
                                VisibleIndex="10">
                                <CellStyle HorizontalAlign="Center">
                                </CellStyle>
                            </dx:GridViewDataDateColumn>
                            ...
                            <dx:GridViewDataTextColumn FieldName="CreateStaffID" Visible="False" 
                                VisibleIndex="11">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataDateColumn FieldName="CreateDate" Visible="False" 
                                VisibleIndex="12">
                            </dx:GridViewDataDateColumn>
        ...
        &nbsp;&nbsp;</strong></td>
                    <td class="style100">
    <strong>
                        <dx:ASPxLabel ID="lblSelectedDocName" runat="server" ForeColor="Blue" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ConnectionString="<%$ ConnectionStrings:dbvilas197ConnectionString %>" 
                SelectCommand="SELECT IssueID, DocID, IssueNo, IssueDate, DecisionNo, DecisionDate, NotesOfUpdating, FileName, URL, ExpireDate, Invalid, CreateStaffID, CreateDate, ModifyStaffID, ModifyDate, Deleted FROM QS_DocIssues WHERE (DocID = @DocID)" 
